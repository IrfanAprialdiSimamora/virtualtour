...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <?php
  include "koneksi.php";
  $query="SELECT * FROM desa WHERE id_desa=11";
  $result=mysqli_query($koneksi,$query);
...
?> 
    <h3 align="center">Virtual Reality Tour Polewali Mandar</h3>
    <p align="justify"><?php echo $data['deskripsi'];?></p>
    <center>
    <iframe width="680" height="315" src="https://www.youtube.com/embed/<?php echo $data['linkvid']; ?>" frameborder="0" allowfullscreen></iframe>
    </center>
    <?php
    include "koneksi.php";   
